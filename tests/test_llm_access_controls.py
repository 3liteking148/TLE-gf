...
class TestBanCommands:
    def test_moderator_can_ban_list_and_unban(self, db):
        ...
        moderator = FakeCtx(roles=(constants.TLE_MODERATOR[0],))
        ...
        listing = FakeCtx(roles=(constants.TLE_MODERATOR[0],))
        ...
        unban = FakeCtx(roles=(constants.TLE_MODERATOR[0],))
...
class TestDisableCommands:
    def test_guild_commands_reset_overrides_and_affect_every_channel(self, db):
        ...
        cog = llm_cog.Llm(bot=None)
        ctx = FakeCtx(roles=(constants.TLE_MODERATOR[0],), channel=_channel(44))
    ...
    def test_enable_here_threads_reopens_parent_and_all_threads(self, db):
        ...
        global_ctx = FakeCtx(
            roles=(constants.TLE_MODERATOR[0],), channel=parent)
        thread_ctx = FakeCtx(
            roles=(constants.TLE_MODERATOR[0],), channel=thread)
    ...
    def test_channel_and_threads_have_independent_exact_overrides(self, db):
        ...
        cog = llm_cog.Llm(bot=None)
        parent_ctx = FakeCtx(
            roles=(constants.TLE_MODERATOR[0],), channel=_channel(44))
        thread_ctx = FakeCtx(
            roles=(constants.TLE_MODERATOR[0],),
